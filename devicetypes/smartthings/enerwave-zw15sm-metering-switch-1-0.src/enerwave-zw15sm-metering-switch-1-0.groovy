 ...
 */
metadata {
	definition (name: "Enerwave ZW15SM Metering Switch 1.0", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.switch") {
...
def parse(String description) {
	log.debug "In parse(), description == $description"
	def result = null
...
def zwaveEvent(physicalgraph.zwave.commands.basicv1.BasicReport cmd)
{
	...
	def evt = createEvent(name: "switch", value: value, type: "physical", descriptionText: "$device.displayName was turned \"$value\" successfully via physical switch")
...
{
	def value = (cmd.value ? "on" : "off")
	createEvent(name: "switch", value: value, type: "digital", descriptionText: "$device.displayName was turned \"$value\" successfully via app i.e. digitally")
}
...
private encap(physicalgraph.zwave.Command cmd) {
	log.debug "In encap() zwaveInfo ==> $zwaveInfo"
